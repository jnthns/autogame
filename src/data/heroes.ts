...
export const HEROES: HeroDef[] = [
  ...
  },
  {
    ...
    quirk: 'Cheapest crit engine. 35% base crit rate, damage amplifier. Ranged only.',
  },
  {
    id: 'bunyi',
    name: 'Bunyip',
  ...
  },
  {
    ...
    quirk: 'Spray damage that scales absurdly with crit sources. Ranged only.',
  },
  {
    id: 'ifrit',
    name: 'Ifrit',
  ...
  },
  {
    ...
    quirk: 'Cheapest Sky crit engine. Fast hands, chaos CC, and a board-wide crit tilt. Ranged only.',
  },
  {
    id: 'griff',
    name: 'Griffin',
  ...
  },
  {
    ...
    quirk: 'Sustain enabler. Keeps the frontline alive so Serpent lifesteal can finish the job. Ranged only.',
  },
  {
    id: 'camaz',
    name: 'Camazotz',
