...
export const ABILITIES: Record<string, AbilityDef> = {
  ...
  jorm: { base: 245, value: { damage: { from: 'base', targets: 1.5 }, healRatio: 0.5 } },
  ...
  kitsu: { base: 26, secondary: 9, secondaryKind: 'count', value: { hits: { from: 'base', count: 9 } } },
  ...
  zirni: { base: 185, value: { damage: { from: 'base', targets: 3 }, secondCast: true } },
  ...
  barng: { base: 105, value: { shield: { from: 'base', allies: 4 } } },
  ...
  nuwa: { base: 185, value: { heal: { from: 'base', allies: 2 }, allyBuff: { allies: 2 } } },
  // Tears the nearest enemy and heals for everything dealt.
  camaz: { base: 180, value: { damage: { from: 'base', targets: 1 }, healRatio: 1 } },
